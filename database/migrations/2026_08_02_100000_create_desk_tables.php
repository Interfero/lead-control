...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('crm_connections', function (Blueprint $table) {
            $table->id();
            $table->string('name');
            $table->string('type', 64); // crm1_eloquent, crm2_http
        ...
        Schema::create('desk_status_mappings', function (Blueprint $table) {
            ...
            $table->string('unified_status', 32); // new, in_progress, on_way, ready, closed
        ...
        Schema::create('orders_cache', function (Blueprint $table) {
            ...
            $table->string('status', 32)->index(); // unified
            ...
            $table->string('order_type', 32)->nullable(); // first, repeat, warranty
            ...
            $table->index(['status', 'created_at_local']);
        ...
        Schema::create('desk_logs', function (Blueprint $table) {
            ...
            $table->string('level', 16)->default('info')->index(); // error, warning, info
